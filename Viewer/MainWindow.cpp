    ...
    is_main(false)
{
  ...
  QAction* actionCouleurCarac = new QAction("&Show Caracteristique color", this);
  actionCouleurCarac->setObjectName("actionCouleurCarac");
  actionCouleurCarac->setCheckable(true);
  actionCouleurCarac->setChecked(false);
  viewMenu->addAction(actionCouleurCarac);
